...
<script type="text/javascript">
  var loop_count=1;
   ...
   html+='<div class="col-md-2"><label for="size_id" class="control-label mb-1">Color</label><select id="size_id" name="size_id[]" class="form-control" >'+size_id_html+'</select></div>';
